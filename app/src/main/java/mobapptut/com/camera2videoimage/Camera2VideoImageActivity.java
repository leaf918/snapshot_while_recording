                    ...
                    switch (mCaptureState) {
                        ...
                        case STATE_WAIT_LOCK:
                            ...
                            if (afState == CaptureResult.CONTROL_AE_MODE_OFF||
                                ...
                                Toast.makeText(Camera2VideoImageActivity.this, "unknow state", Toast.LENGTH_SHORT).show();
                            }
                            break;
                    }
                }
                    ...
                    switch (mCaptureState) {
                        ...
                        case STATE_WAIT_LOCK:
                            ...
                            if (afState == CaptureResult.CONTROL_AE_MODE_OFF
                                ...
                                Toast.makeText(Camera2VideoImageActivity.this, "unknow state" + afState, Toast.LENGTH_SHORT)
                                        .show();
                            }
                            break;
                    }
